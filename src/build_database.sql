...
alter table player_matches
    add foreign key (id_user_home) references users (id_user);
alter table player_matches
    add foreign key (id_user_away) references users (id_user);
...
alter table team_matches
    add foreign key (id_team_home) references teams (id_team);
alter table team_matches
    add foreign key (id_team_away) references teams (id_team);
...
alter table team_matches
    add foreign key (id_referee) references users (id_user);
alter table player_matches
    add foreign key (id_referee) references users (id_user);
...
alter table team_matches
    add foreign key (id_tournament) references tournaments (id_tournament);
alter table player_matches
    add foreign key (id_tournament) references tournaments (id_tournament);
...
alter table teams
    add foreign key (id_player_1) references users (id_user);
alter table teams
    add foreign key (id_player_2) references users (id_user);
...
alter table tournaments
    add foreign key (id_staff) references users (id_user);
...
alter table player_tournament
    ADD FOREIGN KEY (id_tournament) REFERENCES tournaments (id_tournament);
alter table player_tournament
    ADD FOREIGN KEY (id_player) REFERENCES users (id_user);
