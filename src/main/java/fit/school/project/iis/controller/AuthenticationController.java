...
public class AuthenticationController {
	...
	public ResponseEntity<?> saveAccount(@RequestBody AccountTransfer account) throws Exception {
		return ResponseEntity.ok(authenticationInMemoryUserDetailsService.save(account));
	}
